...
def test_check_password_true_for_correct_password():
    user = User("Victor Kingara", "victor@example.com", User.hash_password("mypassword"))
...
def test_role_defaults_to_user():
    user = User("Victor Kingara", "victor@example.com", "somehash")
...
def test_from_dict_roundtrip():
    original = User("Victor Kingara", "victor@example.com", User.hash_password("mypassword"))
